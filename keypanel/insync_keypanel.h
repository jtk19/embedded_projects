...
/* The Rotary Encoder */
#define IN_KP_ROTARY_KEY	18		// the rotary encode as a pressable key
...
#define IN_KP_EVENT_KEY_ID_MASK		0x001F	// the 5 LSB to carry one of up to 32 key id's: KKKKK
